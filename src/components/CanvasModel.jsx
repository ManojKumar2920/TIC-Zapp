...
const CanvasModel = () => {
  ...
  useEffect(() => {
    ...
    const greenTexture = new THREE.TextureLoader().load("green.jpg",
      undefined, undefined, 
      (error) => console.error("Error loading green texture:", error)
    );
    ...
    const redTexture = new THREE.TextureLoader().load("red.png",
      undefined, undefined, 
      (error) => console.error("Error loading red texture:", error)
    );
    ...
    return () => {
      ...
      if (sceneRef.current) sceneRef.current.traverse((child) => {
